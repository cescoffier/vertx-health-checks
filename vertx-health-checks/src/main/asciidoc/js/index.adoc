...
Procedure registration is directly made on the `HealthCheckHandler` instance
...
the given `link:../../jsdoc/module-vertx-js_future-Future.html[Future]` whether or not it succeed. Rules are the following:
