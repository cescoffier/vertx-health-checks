...
----
compile 'io.vertx:vertx-health-checks:3.4.0-SNAPSHOT'
----
...
var healthCheckHandler1 = Java.type("io.vertx.ext.healthchecks.HealthCheckHandler").create(vertx);
var healthCheckHandler2 = Java.type("io.vertx.ext.healthchecks.HealthCheckHandler").create(HealthChecks.create(vertx));
...
[source, js]
----
var healthCheckHandler = Java.type("io.vertx.ext.healthchecks.HealthCheckHandler").create(vertx);
