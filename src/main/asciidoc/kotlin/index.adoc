...
[source, kotlin]
----
var healthCheckHandler1 = io.vertx.ext.healthchecks.HealthCheckHandler.create(vertx)
var healthCheckHandler2 = io.vertx.ext.healthchecks.HealthCheckHandler.create(HealthChecks.create(vertx))
...
[source, kotlin]
----
var healthCheckHandler = io.vertx.ext.healthchecks.HealthCheckHandler.create(vertx)
