...
[source, groovy]
----
def healthCheckHandler1 = io.vertx.ext.healthchecks.HealthCheckHandler.create(vertx)
def healthCheckHandler2 = io.vertx.ext.healthchecks.HealthCheckHandler.create(HealthChecks.create(vertx))
...
[source, groovy]
----
def healthCheckHandler = io.vertx.ext.healthchecks.HealthCheckHandler.create(vertx)
